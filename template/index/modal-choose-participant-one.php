<div class="modal fade modal-aside vertical top bs-modal-choose-participant-one"  tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
						...
						<div class="col-sm-12">
							<div class="panel panel-white no-radius">
								...
								<span class="input-icon">
									<input type="text" placeholder="Search Contact Name" id="form-field-14" class="form-control">
									<i class="fa fa-search"></i>
										...
										<table class="table table-hover" id="sample_2" role="grid" aria-describedby="sample_2_info">
											<thead>
											<tr role="row">
