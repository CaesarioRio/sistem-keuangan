<header class="navbar navbar-default navbar-static-top">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html"> <img class="img-responsive" src="assets/images/dashboard/logo_beac.png" alt="Packet"/> </a>
        <a class="navbar-brand navbar-brand-collapsed" href="index.html"> <img class="img-responsive" src="assets/images/dashboard/logo_beac2.png" alt="" /> </a>
    ...
    <div class="navbar-collapse collapse">
        ...
        <ul class="nav navbar-right" style="display: none !important;">
        ...
        <div style="display: none !important;" class="close-handle visible-xs-block menu-toggler" data-toggle="collapse" href=".navbar-collapse">
            <div class="arrow-left"></div>
            <div class="arrow-right"></div>
        </div>
        <!-- end: MENU TOGGLER FOR MOBILE DEVICES -->
    </div>
    <button style="display: none !important;" class="sidebar-mobile-toggler dropdown-off-sidebar btn hidden-md hidden-lg"  data-toggle-class="app-offsidebar-open" data-toggle-target="#app" data-toggle-click-outside="#off-sidebar">
        &nbsp;
    </button>
    <button style="display: none !important;" class="dropdown-off-sidebar btn hidden-sm hidden-xs" data-toggle-class="app-offsidebar-open" data-toggle-target="#app" data-toggle-click-outside="#off-sidebar">
        &nbsp;
    </button>
    <!-- end: NAVBAR COLLAPSE -->
</header>
