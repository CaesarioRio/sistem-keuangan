									...
									<table class="table table-bordered" id="sample-table-1">
										<thead>
											<tr class="paddings odd">
												<th class="paddings">Neraca Mutasi</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td class="paddings">Tanggal Input</td>
												<td class="paddings">No. Bukti</td>
												<td class="paddings">Tanggal Kwitansi</td>
												<td class="paddings">Keterangan</td>
												<td class="paddings">No. Perk</td>
