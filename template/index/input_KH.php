...
<div id="app" class="lyt-2">
							...
							<div class="panel-body">
								...
								<div>
									<div class="col-sm-3 padding-left-0">
										<button href="" class="btn btn-primary btn-wide btn-o margin-top-10" data-toggle="modal" data-target=".modal-import-kh"><i class="fa fa-download"></i> Import</button>
									</div>
	...
	<?php include 'modal/import-kh.php'; ?>
	<!-- start: FOOTER -->
