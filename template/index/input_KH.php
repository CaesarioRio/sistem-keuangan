							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-bordered" id="sample-table-1">
										...
										<tbody>
											<tr>
												<td><input id="form-field-mask-1" class="form-control input-mask-date no-border" type="text"></td>
...
<!-- start: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
		...
		<!-- end: JavaScript Event Handlers for this page --><!-- start: Packet JAVASCRIPTS -->
		<script src="assets/js/letter-icons.js"></script>
		<script src="assets/js/main.js"></script>
		<!-- end: Packet JAVASCRIPTS -->
		<!-- start: JavaScript Event Handlers for this page -->
